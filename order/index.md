...
As of June 2026, the Atlas of Design is distributed by the University of Virginia Press. All volumes are available at the University of Virginia Press [series page](https://www.upress.virginia.edu/series/NACIS/).

If you are a NACIS member, you can get your 35% member discount by ordering on the University of Virginia Press site, using the discount code available when you sign in as a member on the NACIS website, and go to the member discount [page](https://nacis.org/initiatives/atlas-of-design/atlas-member-discount-code/).

<a href="https://www.upress.virginia.edu/series/NACIS/" target="_blank" class="button button-blue">All volumes<i class="fa fa-users"></i></a>

<br>

The Atlas of Design is available from other resellers, including [Amazon](https://www.amazon.com/s?k=%22atlas+of+design%22+North+Amer+Cartographic+Info+Soc). Books can also be ordered from any bookstore that buys from the book wholesaler Ingram. Recommend us to your favorite book retailer!

Order on Amazon from the links below.
