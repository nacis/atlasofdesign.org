$(document).ready(function() { 
  ...
  // show contributor info on map click
  $('.contributor-map').click(function(){
  	$(this).next('.contributor-excerpt').delay(200).slideToggle(500);
  });
  ...
  function translate(lang) {
	...
	// judges map on judge post
  if(document.getElementById('judge-map')) {
